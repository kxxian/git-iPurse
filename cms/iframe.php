...
<div class="wrapper">
  ...
  <div class="content-wrapper iframe-mode bg-dark" data-widget="iframe" data-loading-screen="750">
    <div class="nav navbar navbar-expand-lg navbar-dark border-bottom border-dark p-0">
      <a class="nav-link bg-danger" href="#" data-widget="iframe-close">Close</a>
      <a class="nav-link bg-dark" href="javascript:history.go(-1)" data-widget="iframe-scrollleft"><i class="fas fa-angle-double-left"></i></a>
